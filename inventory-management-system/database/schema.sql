    ...
    -- Drop types if they exist (PostgreSQL 9.1+)
    ...
    -- ENUM TYPES
    -- =====================================================
    CREATE TYPE user_role AS ENUM ('admin', 'sales', 'warehouse', 'supply', 'sales_manager');
    ...
    CREATE TYPE audit_action AS ENUM ('create', 'update', 'delete', 'transfer', 'receive', 'adjust', 'login', 'logout');
    ...
    -- =====================================================
    -- 11. stock_movements (audit trail for stock changes)
    -- =====================================================
    ...
    -- =====================================================
    -- 13. audit_log (comprehensive action logging)
    -- =====================================================
    CREATE TABLE audit_log (
        ...
        entity_type VARCHAR(50) NOT NULL, -- 'warehouse', 'product', 'inventory', 'user', etc.
        entity_id INTEGER,
    ...
    ('Sales Representative', 'sales@ims.com', 'sales123', 'sales'),
    ('Warehouse Manager', 'warehouse@ims.com', 'warehouse123', 'warehouse'),
    ('Supply Manager', 'supply@ims.com', 'supply123', 'supply'),
    ('Sales Manager', 'salesmanager@ims.com', 'salesmanager123', 'sales_manager');
